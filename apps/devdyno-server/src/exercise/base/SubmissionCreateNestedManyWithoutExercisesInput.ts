...
@InputType()
class SubmissionCreateNestedManyWithoutExercisesInput {
...
export { SubmissionCreateNestedManyWithoutExercisesInput as SubmissionCreateNestedManyWithoutExercisesInput };
